...
jQuery(document).ready(function() {
    ...
    jQuery(".css2008_9").text(b.getDate());
    jQuery(".css2008_11").text(b.getFullYear());
    jQuery(".css2008_16").text(dayNames[b.getDay()]);
    jQuery(".css2008_10").text(monthNames[b.getMonth()]);
                    ...
                    if (jQuery(this).hasClass('abierta')) {} else {
                        ...
                        if (count == 2) {
                            ...
                            setTimeout(function() {
                                ...
                                setTimeout(function() {
                                    jQuery('.css2008_37').addClass("load-complete");
                                    jQuery('.css2008_38').css("display", "block");
                                    puedo = true;
                                }, 1000);
                            }, 2000);
