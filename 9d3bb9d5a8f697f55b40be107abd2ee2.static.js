...
function setSecondary() {
    "tar" == jQuery("body").data("type") && 0 < jQuery("[data-igeneric]").length && (jQuery(".img-primary").remove(), jQuery(".img-secondary").removeClass("css2008_15"), jQuery("[data-igeneric]").each(function() {}), jQuery("[data-cgeneric]").each(function() {
...
if (jQuery(document).ready(function() {
        ...
        if (0 < jQuery("#questions_all").length) {
            ...
            jQuery(".questions_of").html(n + "/" + n), jQuery(".css2008_19:not(.qclicked)").on("click", function() {
                var t = parseInt(jQuery(this).data("question"));
                jQuery("#q" + t + " .css2008_19").addClass("qclicked"), null != jQuery(this).data("ok") && (jQuery("#q" + t + " .css2008_19").each(function(t) {
        ...
        } else $(".css2008_20").click(function() {
            $("#q1").fadeOut("slow", function() {
                $("#q2").fadeIn("slow")
            })
        }), $(".css2008_21").click(function() {
            $("#q2").fadeOut("slow", function() {
                $("#q3").fadeIn("slow")
            })
        }), $(".css2008_22").click(function() {
            $("#q3").fadeOut("slow", function() {
                $("#q4").fadeIn("slow")
            })
        }), $(".css2008_24").click(function() {
